package RBI.ICICI;
import RBI.*;
public class ICICIBank implements RBI.Process
{
	...
	public static String ifsc="ICICI00001212";
	public static ICICIBank icici=new ICICIBank();
	public void iciciBank()
	{	
		while(true)
		{
			System.out.println("Enter 1 to Open Account in ICICI Bank!");
			int n=sc.nextInt();
			if(n==1)
			{
				System.out.println(icici.accOpening());
				balance+=sc.nextInt();
		...
		while(true)
		{
			...
			switch(n)
			{
				case 1: System.out.println(icici.deposit());
					System.out.println("-------------------------------------------------");
					break;
				case 2: System.out.println(icici.withdraw());
					System.out.println("--------------------------------------------------");
					break;
				case 3: System.out.println(icici.checkbal());
					System.out.println("--------------------------------------------------");
					break;
				case 4: loan();
					break;
				case 5: System.out.printf("%100s","THANK YOU FOR CHOOSING ICICI BANK");
					System.out.println();
	...
	public int checkbal()
	{
		while(true)
		{
			...
			String n=sc.next();
			System.out.print("\nPlease Enter Your ICICI Bank IFSC code: ");
			String s=sc.next();
	...
	public void Ploan()
	{
		...
		if(n>=750&&n<=800)
		{
			...
			System.out.println("--------------------------------------------------------------------------------------------\n");
			System.out.printf("%100s","THANK YOU FOR CHOOSING ICICI BANK");
			System.out.println();
			System.out.printf("%100s","*********************************");
			System.exit(0);	
 		}
