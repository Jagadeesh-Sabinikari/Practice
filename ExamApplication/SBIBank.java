package RBI.SBI;
import RBI.*;
public class SBIBank implements RBI.Process
{
	...
	public static String ifsc="SBI00001212";
	public static SBIBank sbi=new SBIBank();
	public void sbiBank()
	{	
		while(true)
		{
			System.out.println("Enter 1 to Open Account in SBI Bank!");
			int n=sc.nextInt();
			if(n==1)
			{
				System.out.println(sbi.accOpening());
				balance+=sc.nextInt();
		...
		while(true)
		{
			...
			switch(n)
			{
				case 1: System.out.println(sbi.deposit());
					System.out.println("-------------------------------------------------");
					break;
				case 2: System.out.println(sbi.withdraw());
					System.out.println("--------------------------------------------------");
					break;
				case 3: System.out.println(sbi.checkbal());
					System.out.println("--------------------------------------------------");
					break;
				case 4: loan();
					break;
				case 5: System.out.printf("%100s","THANK YOU FOR CHOOSING SBI BANK");
					System.out.println();
	...
	public String accOpening()
	{
		...
		RBI.Process.loading();
		System.out.println("\n");
		System.out.print("Your SBI BANK Account Number is: ");
	...
	public int checkbal()
	{
		while(true)
		{
			...
			String n=sc.next();
			System.out.print("\nPlease Enter Your SBI Bank IFSC code: ");
			String s=sc.next();
	...
	public void Ploan()
	{
		...
		if(n>=750&&n<=800)
		{
			...
			System.out.println("--------------------------------------------------------------------------------------------\n");
			System.out.printf("%100s","THANK YOU FOR CHOOSING SBI BANK");
			System.out.println();
			System.out.printf("%100s","*********************************");
			System.exit(0);	
 		}
