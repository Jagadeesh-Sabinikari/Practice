package RBI.YES;
import RBI.*;
public class YESBank implements RBI.Process
{
	...
	public static String ifsc="YES00001212";
	public static YESBank yes=new YESBank();
	public void yesBank()
	{	
		while(true)
		{
			System.out.println("Enter 1 to Open Account in YES Bank!");
			int n=sc.nextInt();
			if(n==1)
			{
				System.out.println(yes.accOpening());
				balance+=sc.nextInt();
		...
		while(true)
		{
			...
			switch(n)
			{
				case 1: System.out.println(yes.deposit());
					System.out.println("-------------------------------------------------");
					break;
				case 2: System.out.println(yes.withdraw());
					System.out.println("--------------------------------------------------");
					break;
				case 3: System.out.println(yes.checkbal());
					System.out.println("--------------------------------------------------");
					break;
				case 4: loan();
					break;
				case 5: System.out.printf("%100s","THANK YOU FOR CHOOSING YES BANK");
					System.out.println();
	...
	public String accOpening()
	{
		...
		RBI.Process.loading();
		System.out.println("\n");
		System.out.print("Your YES BANK Account Number is: ");
	...
	public int checkbal()
	{
		while(true)
		{
			...
			String n=sc.next();
			System.out.print("\nPlease Enter Your YES Bank IFSC code: ");
			String s=sc.next();
			...
			{
				System.out.println("\nPlease Check Your Account Number and IFSC code\n");	
			}
		}
	}
	public void loan()
	...
	public void Ploan()
	{
		...
		if(n>=750&&n<=800)
		{
			...
			System.out.println("--------------------------------------------------------------------------------------------\n");
			System.out.printf("%100s","THANK YOU FOR CHOOSING YES BANK");
			System.out.println();
			System.out.printf("%100s","*********************************");
			System.exit(0);	
 		}
