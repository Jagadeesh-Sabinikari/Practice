package RBI.AXIS;
import RBI.*;
public class AXISBank implements RBI.Process
{
	...
	public static String ifsc="AXIS00001212";
	public static AXISBank axis=new AXISBank();
	public void axisBank()
	{	
		while(true)
		{
			System.out.println("Enter 1 to Open Account in AXIS Bank!");
			int n=sc.nextInt();
			if(n==1)
			{
				System.out.println(axis.accOpening());
				balance+=sc.nextInt();
		...
		while(true)
		{
			...
			switch(n)
			{
				case 1: System.out.println(axis.deposit());
					System.out.println("-------------------------------------------------");
					break;
				case 2: System.out.println(axis.withdraw());
					System.out.println("--------------------------------------------------");
					break;
				case 3: System.out.println(axis.checkbal());
					System.out.println("--------------------------------------------------");
					break;
				case 4: loan();
					break;
				case 5: System.out.printf("%100s","THANK YOU FOR CHOOSING AXIS BANK");
					System.out.println();
	...
	public int checkbal()
	{
		while(true)
		{
			...
			String n=sc.next();
			System.out.print("\nPlease Enter Your AXIS Bank IFSC code: ");
			String s=sc.next();
	...
	public void Ploan()
	{
		...
		if(n>=750&&n<=800)
		{
			...
			System.out.println("--------------------------------------------------------------------------------------------\n");
			System.out.printf("%100s","THANK YOU FOR CHOOSING AXIS BANK");
			System.out.println();
			System.out.printf("%100s","*********************************");
			System.exit(0);	
 		}
